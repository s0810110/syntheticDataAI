...
function [] = NeuralNetwork_noPosterior_CV_iterations_L2()
...
%% Training
[net]=BP_TB_L2(train_prod_50,train_labels_50,desired_error,Learning_Rate,hidden_layers,plotting,lambda);
%%%%%%%%%%% prediction
%% Prediction 
