...
function [] = NeuralNetwork_noPosterior_L2()
...
Aug_prod_7=readtable('model_input/synthPropRF_seed_7.csv');

Aug_prod_7 = table2array(Aug_prod_7);

Aug_labels_7 = Aug_prod_7(:,end);
Aug_prod_7 = Aug_prod_7(:,1:end-2);
...
%combine original and augmentation training sets 
trainAug_prod_7 = vertcat(train_prod_7, Aug_prod_7);

trainAugLabels_prod_7 = vertcat(train_labels_7, Aug_labels_7);

save('PreprocessNoPosteriorData/trainAug_prod_7.mat', 'trainAug_prod_7');

load('PreprocessNoPosteriorData/trainAug_prod_7.mat');
...
%% Training
[net]=BP_TB_L2(trainAug_prod_7,trainAugLabels_prod_7,desired_error,Learning_Rate,hidden_layers,plotting, lambda);
%%%%%%%%%%% prediction
%% Prediction 
